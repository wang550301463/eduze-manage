...
class CurriculumSeedIT extends AbstractITContainerTest {
    ...
    void stageCount_is5() {
        Integer count =
                jdbc.queryForObject(
                        "SELECT COUNT(*) FROM t_curriculum_stage WHERE deleted_at=0",
                        Integer.class);
    ...
    void dimensionCount_is22_and_breakdown() {
        Integer total =
                jdbc.queryForObject(
                        "SELECT COUNT(*) FROM t_curriculum_dimension WHERE deleted_at=0",
                        Integer.class);
    ...
    void stageDimensionMappingExists() {
        Integer count =
                jdbc.queryForObject("SELECT COUNT(*) FROM t_stage_dimension", Integer.class);
    ...
    void demoCourses_5() {
        Integer count =
                jdbc.queryForObject(
                        "SELECT COUNT(*) FROM t_course WHERE deleted_at=0 AND name LIKE '%·%'",
                        Integer.class);
        assertThat(count).isEqualTo(5);
    }
}
