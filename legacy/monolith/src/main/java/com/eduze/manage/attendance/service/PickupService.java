...
public class PickupService {
    ...
    public List<PickupRecordResponse> list(Long lessonId, Long studentId, Integer isAbnormal) {
        ...
        return pickupRecordMapper
                .selectList(
                        Wrappers.<PickupRecord>lambdaQuery()
    ...
    private PickupRecordResponse toResponse(PickupRecord record) {
        Attendance attendance = attendanceMapper.selectById(record.getAttendanceId());
        Student student =
                attendance != null ? studentMapper.selectById(attendance.getStudentId()) : null;
        Guardian guardian =
                record.getGuardianId() != null
                        ? guardianMapper.selectById(record.getGuardianId())
                        : null;
