...
public class AttendanceSupport {
    ...
    public boolean hasApprovedLeave(Long studentId, LocalDate date) {
        Long count = leaveRequestMapper.selectCount(Wrappers.<LeaveRequest>lambdaQuery()
    ...
    public boolean isAuthorizedPickup(Long studentId, Long guardianId) {
        ...
        Long linked = relationMapper.selectCount(Wrappers.<StudentGuardianRelation>lambdaQuery()
        ...
        return guardian != null
                && guardian.getCanPickup() != null
                && guardian.getCanPickup() == 1;
    }
