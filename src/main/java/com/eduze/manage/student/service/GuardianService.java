...
public class GuardianService {
    ...
    public GuardianResponse create(GuardianRequest request) {
        ...
        guardian.setIsMainContact(request.getIsMainContact() != null ? request.getIsMainContact() : 0);
    ...
    @Transactional
    public GuardianResponse linkToStudent(Long studentId, Long guardianId, LinkGuardianRequest request) {
        requireStudent(studentId);
        Guardian guardian = requireGuardian(guardianId);

        StudentGuardianRelation existing = relationMapper.selectOne(
                Wrappers.<StudentGuardianRelation>lambdaQuery()
                        .eq(StudentGuardianRelation::getTenantId, TenantContext.getTenantId())
