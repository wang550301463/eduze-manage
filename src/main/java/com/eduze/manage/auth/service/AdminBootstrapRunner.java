...
public class AdminBootstrapRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Long tenantId = appProperties.getTenant().getDefaultId() == null
                ? 1L
        ...
        boolean hasBootstrap = bootstrapUser != null
    ...
    private void ensureRoleAndBranch(Long userId, Long tenantId) {
        Long roleCount = userRoleMapper.selectCount(Wrappers.<UserRole>lambdaQuery()
        ...
        Long branchCount = userBranchMapper.selectCount(Wrappers.<UserBranch>lambdaQuery()
