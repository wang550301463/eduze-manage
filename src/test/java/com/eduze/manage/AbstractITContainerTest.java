...
/**
 * Shared MySQL + Redis for all *IT classes in one JVM.
 * Manual start avoids per-class {@code @Container} lifecycle churn that caused
 * connection timeouts when running the full integration suite.
 */
@SpringBootTest
@ActiveProfiles("test")
