...
public class JwtService {
    ...
    public JwtService(AppProperties appProperties) {
        ...
        int accessMin =
                appProperties.getJwt().getAccessTtlMin() != null
                        ? appProperties.getJwt().getAccessTtlMin()
                        : 15;
        int refreshDay =
                appProperties.getJwt().getRefreshTtlDay() != null
    ...
    public String generateScoped(
        ...
        long ttl = TYPE_ACCESS.equals(type) ? accessTtlSeconds : refreshTtlSeconds;
        return Jwts.builder()
                .id(jti)
                .subject(String.valueOf(userId))
                .claim(CLAIM_TENANT, tenantId)
                .claim(CLAIM_TOKEN_VERSION, version)
                .claim(CLAIM_BRANCHES, branches)
                .claim(CLAIM_ROLES, roles)
                .claim(CLAIM_AUTHS, auths)
                .claim(CLAIM_TYPE, type)
                .claim(CLAIM_ACTIVE_ROLE, activeRole)
